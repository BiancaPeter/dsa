...
public class ReverseWordsInString {
    ...
    //sol2:
    //cu 2 pointer, unul la inceput, unul la sfarsit - cel de la inceput il increteam, cel de la sf il decrementam
    //inversam elementele de la i si j la fiecare pas
